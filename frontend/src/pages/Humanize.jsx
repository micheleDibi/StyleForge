...
const Humanize = () => {
  ...
  const handleCompilatioScan = async () => {
    ...
    try {
      const response = await startCompilatioScan(result, 'humanize', compilatioJobId || jobStatus?.job_id);
    ...
    <div className="min-h-screen p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex gap-2 mb-6">
          <button
            onClick={() => { setMode('correction'); setResult(''); setJobStatus(null); setCompilatioResult(null); setCompilatioError(null); }}
