      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-orange-50 p-6">
          <div className="max-w-md text-center">
            ...
            <h1 className="text-2xl font-bold text-slate-900 mb-2">{t('Qualcosa e andato storto')}</h1>
            <p className="text-slate-500 mb-6">
              {t('Si e verificato un errore imprevisto. Ricarica la pagina per continuare.')}
            </p>
            <button
